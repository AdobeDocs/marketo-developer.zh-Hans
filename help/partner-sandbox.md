...
在接受合作伙伴进入之后配置沙盒  [Adobe Exchange合作伙伴计划，数字体验](https://partners.adobe.com/technologyprogram/experiencecloud.html)。 在大多数方面，合作伙伴沙盒在功能上等同于生产实例。 合作伙伴沙盒未安装加载项模块，并已设置固定容量限制。 以下是一个常见问题解答，随后是合作伙伴沙盒功能摘要。
